...
export const TextOverlay: React.FC<{ title: string; subtitle: string }> = ({ title, subtitle }) => {
  return (
    <div className="absolute w-full h-full pointer-events-none flex flex-col justify-between p-10">
      {/* Top Left Title - Now optional since Main handles static title too, but kept for flexibility */}
...
const StrokedText: React.FC<{
    ...
    return (
        <div className="relative inline-block" style={{ fontSize, fontFamily: 'sans-serif', fontWeight: 900, lineHeight: 1.2 }}>
            {/* Outer Stroke (Black) */}
